	...
	$(document).ready(function(){
		...
		$('.pestTD').click(function(){
			...
			$.post('loadPestDetail.php',{
					...
					if($('#divDetail').offset().left+$('#divDetail').width()>$(window).width()){
						var temp=offsetLeft-$('#divDetail').width()-50;
